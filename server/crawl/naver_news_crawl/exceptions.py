...
# Title Parse 에러
class TitleParseError(Exception):
    def __init__(self, title):
        self.message = f'Error while parsing {title}'
...
class BodyParseError(Exception):
    def __init__(self, body):
        self.message = f'Error while parsing {body}'
...
# Press Parse 에러
class PressParseError(Exception):
    def __init__(self, press):
        self.message = f'Error while parsing {press}'
...
class DateParseError(Exception):
    def __init__(self, date):
        self.message = f'Error while parsing {date}'
...
class ImageParseError(Exception):
    def __init__(self, image):
        self.message = f'Error while parsing {image}'
